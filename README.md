...
``` r
mite[27,] #Debes colocar tu número asignado dentro del corchete donde corresponda.
...
\*\*Tus respuestas en este bloque de código:*4*

``` r
mite[27,4] #Debes colocar tu número en el índice de filas, y en el otro el de la columna. Lee la guía
## [1] 3
```
